...
const vid = ['https://files.catbox.moe/a0vum9.mp4', 'https://files.catbox.moe/a0vum9.mp4', 'https://files.catbox.moe/a0vum9.mp4']
...
await conn.sendMessage(m.chat, { video: { url: vid.getRandom() }, caption: text.trim(), contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, newsletterName: channelRD.name, serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: textbot, body: dev, thumbnailUrl: 'https://files.catbox.moe/0gel94.jpg', sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
